...
//
// Usage:
//   wiki                           # Full-screen TUI (Shift+click to select text)
//   wiki --inline                  # Inline mode (native click-drag selection)
...
func main() {
	...
	inlineMode := flag.Bool("inline", false, "Inline mode (native click-drag text selection)")
	flag.Parse()
